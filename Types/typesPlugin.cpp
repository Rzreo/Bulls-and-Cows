...
/* ------------------------------------------------------------------------
Enum Type: SERVER_CONNECT_MESSAGE_TYPE
* ------------------------------------------------------------------------ */
...
Boolean
SERVER_CONNECT_MESSAGE_TYPEPlugin::serialize(
    TypePluginEndpointData^ endpoint_data,
    SERVER_CONNECT_MESSAGE_TYPE sample,
    CdrStream% stream, 
    Boolean serialize_encapsulation,
    UInt16 final_encapsulation_id,
    Boolean serialize_sample,
...
Boolean 
SERVER_CONNECT_MESSAGE_TYPEPlugin::deserialize_sample(
    TypePluginEndpointData^ endpoint_data,
    SERVER_CONNECT_MESSAGE_TYPE% sample,
    CdrStream% stream, 
    Boolean deserialize_encapsulation,  
    ...
    Object^ endpoint_plugin_qos)
{
    ...
    if (deserialize_data) {
        ...
        sample = stream.deserialize_enum<SERVER_CONNECT_MESSAGE_TYPE>();
        ...
        switch (sample){
            ...
            case SERVER_CONNECT_MESSAGE_TYPE::REQUEST_GO_TO_ROOM:
            {
            }  break;
            default:
            {
                ...
                if (epd == nullptr || epd->sample_assignability_property.acceptUnknownEnumValue) {
                    sample = SERVER_CONNECT_MESSAGE_TYPE::SERVER_CONNECT_SUCCESS;
                } else {
                    throw gcnew Unassignable("invalid enumerator " + sample.ToString());
                }
            } break;
...
Boolean
SERVER_CONNECT_MESSAGE_TYPEPlugin::skip(
    TypePluginEndpointData^ endpoint_data,
    CdrStream% stream, 
    Boolean skip_encapsulation,  
    Boolean skip_sample, 
...
UInt32
SERVER_CONNECT_MESSAGE_TYPEPlugin::get_serialized_sample_max_size(
    TypePluginEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32
SERVER_CONNECT_MESSAGE_TYPEPlugin::get_serialized_sample_min_size(
    TypePluginEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32
SERVER_CONNECT_MESSAGE_TYPEPlugin::get_serialized_sample_size(
    TypePluginEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment,
...
Boolean
SERVER_CONNECT_MESSAGE_TYPEPlugin::serialize_key(
    TypePluginEndpointData^ endpoint_data,
    SERVER_CONNECT_MESSAGE_TYPE sample,
    CdrStream% stream,
    Boolean serialize_encapsulation,
...
Boolean
SERVER_CONNECT_MESSAGE_TYPEPlugin::serialize_key_for_keyhash(
    TypePluginEndpointData^ endpoint_data,
    SERVER_CONNECT_MESSAGE_TYPE sample,
    CdrStream% stream,
    Boolean serialize_encapsulation,
...
Boolean
SERVER_CONNECT_MESSAGE_TYPEPlugin::deserialize_key_sample(
    TypePluginEndpointData^ endpoint_data,
    SERVER_CONNECT_MESSAGE_TYPE% sample,
    CdrStream% stream,
    Boolean deserialize_encapsulation,
...
UInt32
SERVER_CONNECT_MESSAGE_TYPEPlugin::get_serialized_key_max_size(
    TypePluginEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 encapsulation_id,
    UInt32 current_alignment)
...
UInt32
SERVER_CONNECT_MESSAGE_TYPEPlugin::get_serialized_key_for_keyhash_max_size(
    TypePluginEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 encapsulation_id,
    UInt32 current_alignment)
...
Boolean
SERVER_CONNECT_MESSAGE_TYPEPlugin::serialized_sample_to_key(
    TypePluginEndpointData^ endpoint_data,
    SERVER_CONNECT_MESSAGE_TYPE% sample,
    CdrStream% stream, 
    Boolean deserialize_encapsulation,  
...
void
SERVER_CONNECT_MESSAGE_TYPEPlugin::print_data(
    SERVER_CONNECT_MESSAGE_TYPE sample,
    String^ description,
    UInt32 indent_level)
{
    ...
    RTICdrType_printEnum((RTICdrEnum*) &sample,
    "SERVER_CONNECT_MESSAGE_TYPE", indent_level + 1);
}
/* ------------------------------------------------------------------------
* Plug-in Lifecycle Methods
* ------------------------------------------------------------------------ */

SERVER_CONNECT_MESSAGE_TYPEPlugin^
SERVER_CONNECT_MESSAGE_TYPEPlugin::get_instance() {
    if (_singleton == nullptr) {
        _singleton = gcnew SERVER_CONNECT_MESSAGE_TYPEPlugin();
    }
    return _singleton;
}

void
SERVER_CONNECT_MESSAGE_TYPEPlugin::dispose() {
    delete _singleton;
    _singleton = nullptr;
}
...
/* ------------------------------------------------------------------------
*  Type BAC_SERVER_CONNECT_MESSAGE
* ------------------------------------------------------------------------ */
...
void 
BAC_SERVER_CONNECT_MESSAGEPlugin::print_data(
...
Boolean 
BAC_SERVER_CONNECT_MESSAGEPlugin::serialize(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_SERVER_CONNECT_MESSAGE^ sample,
    CdrStream% stream,    
    Boolean serialize_encapsulation,
...
Boolean 
BAC_SERVER_CONNECT_MESSAGEPlugin::deserialize_sample(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_SERVER_CONNECT_MESSAGE^ sample,
    CdrStream% stream,   
    Boolean deserialize_encapsulation,
...
Boolean
BAC_SERVER_CONNECT_MESSAGEPlugin::skip(
    TypePluginDefaultEndpointData^ endpoint_data,
    CdrStream% stream,   
    Boolean skip_encapsulation,
    Boolean skip_sample, 
...
*/
UInt32 
BAC_SERVER_CONNECT_MESSAGEPlugin::get_serialized_sample_max_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32
BAC_SERVER_CONNECT_MESSAGEPlugin::get_serialized_sample_min_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32 
BAC_SERVER_CONNECT_MESSAGEPlugin::get_serialized_sample_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment,
...
UInt32
BAC_SERVER_CONNECT_MESSAGEPlugin::get_serialized_key_max_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32
BAC_SERVER_CONNECT_MESSAGEPlugin::get_serialized_key_for_keyhash_max_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
Boolean 
BAC_SERVER_CONNECT_MESSAGEPlugin::serialize_key(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_SERVER_CONNECT_MESSAGE^ sample,
    CdrStream% stream,    
    Boolean serialize_encapsulation,
...
Boolean 
BAC_SERVER_CONNECT_MESSAGEPlugin::serialize_key_for_keyhash(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_SERVER_CONNECT_MESSAGE^ sample,
    CdrStream% stream,    
    Boolean serialize_encapsulation,
...
Boolean BAC_SERVER_CONNECT_MESSAGEPlugin::deserialize_key_sample(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_SERVER_CONNECT_MESSAGE^ sample,
    CdrStream% stream, 
    Boolean deserialize_encapsulation,
...
Boolean
BAC_SERVER_CONNECT_MESSAGEPlugin::serialized_sample_to_key(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_SERVER_CONNECT_MESSAGE^ sample,
    CdrStream% stream, 
    Boolean deserialize_encapsulation,  
...
BAC_SERVER_CONNECT_MESSAGEPlugin^
BAC_SERVER_CONNECT_MESSAGEPlugin::get_instance() {
    if (_singleton == nullptr) {
        _singleton = gcnew BAC_SERVER_CONNECT_MESSAGEPlugin();
    }
    return _singleton;
}

void
BAC_SERVER_CONNECT_MESSAGEPlugin::dispose() {
    delete _singleton;
    _singleton = nullptr;
}

/* ------------------------------------------------------------------------
*  Type BAC_CLIENT_CONNECT_MESSAGE
* ------------------------------------------------------------------------ */
...
void 
BAC_CLIENT_CONNECT_MESSAGEPlugin::print_data(
...
Boolean 
BAC_CLIENT_CONNECT_MESSAGEPlugin::serialize(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_CLIENT_CONNECT_MESSAGE^ sample,
    CdrStream% stream,    
    Boolean serialize_encapsulation,
...
Boolean 
BAC_CLIENT_CONNECT_MESSAGEPlugin::deserialize_sample(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_CLIENT_CONNECT_MESSAGE^ sample,
    CdrStream% stream,   
    Boolean deserialize_encapsulation,
...
Boolean
BAC_CLIENT_CONNECT_MESSAGEPlugin::skip(
    TypePluginDefaultEndpointData^ endpoint_data,
    CdrStream% stream,   
    Boolean skip_encapsulation,
    Boolean skip_sample, 
...
*/
UInt32 
BAC_CLIENT_CONNECT_MESSAGEPlugin::get_serialized_sample_max_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32
BAC_CLIENT_CONNECT_MESSAGEPlugin::get_serialized_sample_min_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32 
BAC_CLIENT_CONNECT_MESSAGEPlugin::get_serialized_sample_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment,
...
UInt32
BAC_CLIENT_CONNECT_MESSAGEPlugin::get_serialized_key_max_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
UInt32
BAC_CLIENT_CONNECT_MESSAGEPlugin::get_serialized_key_for_keyhash_max_size(
    TypePluginDefaultEndpointData^ endpoint_data,
    Boolean include_encapsulation,
    UInt16 final_encapsulation_id,
    UInt32 current_alignment)
...
Boolean 
BAC_CLIENT_CONNECT_MESSAGEPlugin::serialize_key(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_CLIENT_CONNECT_MESSAGE^ sample,
    CdrStream% stream,    
    Boolean serialize_encapsulation,
...
Boolean 
BAC_CLIENT_CONNECT_MESSAGEPlugin::serialize_key_for_keyhash(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_CLIENT_CONNECT_MESSAGE^ sample,
    CdrStream% stream,    
    Boolean serialize_encapsulation,
...
Boolean BAC_CLIENT_CONNECT_MESSAGEPlugin::deserialize_key_sample(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_CLIENT_CONNECT_MESSAGE^ sample,
    CdrStream% stream, 
    Boolean deserialize_encapsulation,
...
Boolean
BAC_CLIENT_CONNECT_MESSAGEPlugin::serialized_sample_to_key(
    TypePluginDefaultEndpointData^ endpoint_data,
    BAC_CLIENT_CONNECT_MESSAGE^ sample,
    CdrStream% stream, 
    Boolean deserialize_encapsulation,  
...
BAC_CLIENT_CONNECT_MESSAGEPlugin^
BAC_CLIENT_CONNECT_MESSAGEPlugin::get_instance() {
    if (_singleton == nullptr) {
        _singleton = gcnew BAC_CLIENT_CONNECT_MESSAGEPlugin();
    }
    return _singleton;
}

void
BAC_CLIENT_CONNECT_MESSAGEPlugin::dispose() {
    delete _singleton;
    _singleton = nullptr;
}
