...
DDS_TypeCode* CLIENT_CONNECT_MESSAGE_TYPE_get_typecode()
{
    ...
    static DDS_TypeCode_Member CLIENT_CONNECT_MESSAGE_TYPE_g_tc_members[6]=
    {
        ...
        {
            (char *)"REQUEST_ROOM_LIST",/* Member name */
            {
                0, /* Ignored */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
            ...
            (RTICdrLong)CLIENT_CONNECT_MESSAGE_TYPE::REQUEST_ROOM_LIST, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
        ...
        }, 
        {
            ...
            (RTICdrLong)CLIENT_CONNECT_MESSAGE_TYPE::ENTER_ROOM, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
        ...
        {
            (char *)"REQUEST_ROOM_DATA",/* Member name */
            {
                0, /* Ignored */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
            ...
            (RTICdrLong)CLIENT_CONNECT_MESSAGE_TYPE::REQUEST_ROOM_DATA, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
...
DDS_TypeCode* SERVER_CONNECT_MESSAGE_TYPE_get_typecode()
{
    ...
    static DDS_TypeCode_Member SERVER_CONNECT_MESSAGE_TYPE_g_tc_members[8]=
    {
        ...
        {
            (char *)"SEND_ROOM_DATA",/* Member name */
            {
                0, /* Ignored */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
            ...
            (RTICdrLong)SERVER_CONNECT_MESSAGE_TYPE::SEND_ROOM_DATA, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
        ...
        {
            (char *)"REQUEST_GAME_START",/* Member name */
            {
                0, /* Ignored */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
            ...
            (RTICdrLong)SERVER_CONNECT_MESSAGE_TYPE::REQUEST_GAME_START, 
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            RTI_CDR_REQUIRED_MEMBER, /* Is a key? */
