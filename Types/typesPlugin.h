...
public ref class BAC_AVAILABLE_IDsPlugin :
DefaultTypePlugin<BAC_AVAILABLE_IDs^> {
    // --- Support methods: ------------------------------------------------------
  public:
    void print_data(
  ...
  public:
    ...
    virtual System::UInt32 get_serialized_sample_size(
        ...
        BAC_AVAILABLE_IDs^ sample) override;
  ...
  public:
    static BAC_AVAILABLE_IDsPlugin^ get_instance();
  ...
  private:
    ...
    : DefaultTypePlugin(
        ...
        BAC_AVAILABLE_IDs::get_typecode()) {
        #else
        nullptr) {
            #endif
            // empty
        ...
        static BAC_AVAILABLE_IDsPlugin^ _singleton;
    };
    ...
    * ------------------------------------------------------------------------ */
    ...
    public ref class BAC_CREATE_ROOMPlugin :
    DefaultTypePlugin<BAC_CREATE_ROOM^> {
        // --- Support methods: ------------------------------------------------------
      public:
        void print_data(
      ...
      public:
        ...
        virtual System::UInt32 get_serialized_sample_size(
            ...
            UInt16 encapsulation_id,
            UInt32 current_alignment,
            BAC_CREATE_ROOM^ sample) override;
      ...
      public:
        ...
        // ---  Plug-in lifecycle management methods: --------------------------------
      public:
        static BAC_CREATE_ROOMPlugin^ get_instance();
      ...
      private:
        ...
        : DefaultTypePlugin(
            ...
            static BAC_CREATE_ROOMPlugin^ _singleton;
        };
