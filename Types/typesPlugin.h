...
public ref class BAC_CONNECTPlugin :
DefaultTypePlugin<BAC_CONNECT^> {
    // --- Support methods: ------------------------------------------------------
  public:
    void print_data(
        BAC_CONNECT^ sample,
  ...
  public:
    ...
    virtual System::Boolean instance_to_key(
        TypePluginDefaultEndpointData^ endpoint_data,
        BAC_CONNECT^ key,
        BAC_CONNECT^ instance) override;

    virtual System::Boolean key_to_instance(
        TypePluginDefaultEndpointData^ endpoint_data,
        BAC_CONNECT^ instance,
        BAC_CONNECT^ key) override;
  ...
  public:
    static BAC_CONNECTPlugin^ get_instance();
  ...
  private:
    ...
    : DefaultTypePlugin(
        ...
        static BAC_CONNECTPlugin^ _singleton;
    };
