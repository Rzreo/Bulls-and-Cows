...
ref class BAC_SERVER_CONNECT_MESSAGEPlugin;

/* A collection of useful methods for dealing with objects of type
* BAC_SERVER_CONNECT_MESSAGE.
*/
public ref class BAC_SERVER_CONNECT_MESSAGETypeSupport
: public DDS::TypedTypeSupport<BAC_SERVER_CONNECT_MESSAGE^> {
    // --- Type name: --------------------------------------------------------
  public:
    static System::String^ TYPENAME = "BAC_SERVER_CONNECT_MESSAGE";
  ...
  public:
    ...
    */
    ...
    /* Create an instance of the BAC_SERVER_CONNECT_MESSAGE type.
    */
    static BAC_SERVER_CONNECT_MESSAGE^ create_data();

    /* If instances of the BAC_SERVER_CONNECT_MESSAGE type require any
    * explicit finalization, perform it now on the given sample.
    */
    static void delete_data(BAC_SERVER_CONNECT_MESSAGE^ data);

    /* Write the contents of the data sample to standard out.
    */
    static void print_data(BAC_SERVER_CONNECT_MESSAGE^ a_data);

    /* Perform a deep copy of the contents of one data sample over those of
    * another, overwriting it.
    */
    static void copy_data(
        BAC_SERVER_CONNECT_MESSAGE^ dst_data,
        BAC_SERVER_CONNECT_MESSAGE^ src_data);
  ...
  public:
    ...
    virtual BAC_SERVER_CONNECT_MESSAGE^ create_data_untyped() override;

  public:
    static BAC_SERVER_CONNECT_MESSAGETypeSupport^ get_instance();

    BAC_SERVER_CONNECT_MESSAGETypeSupport();

  private:
    static BAC_SERVER_CONNECT_MESSAGETypeSupport^ _singleton;
    BAC_SERVER_CONNECT_MESSAGEPlugin^ _type_plugin;
};
...
/**
* A reader for the BAC_SERVER_CONNECT_MESSAGE type.
*/
public ref class BAC_SERVER_CONNECT_MESSAGEDataReader :
public DDS::TypedDataReader<BAC_SERVER_CONNECT_MESSAGE^> {
    /* The following code is for the use of the middleware infrastructure.
    * Applications are not expected to call it directly.
    */
    internal:
    BAC_SERVER_CONNECT_MESSAGEDataReader(System::IntPtr impl);
};
...
/**
* A writer for the BAC_SERVER_CONNECT_MESSAGE user type.
*/
public ref class BAC_SERVER_CONNECT_MESSAGEDataWriter :
public DDS::TypedDataWriter<BAC_SERVER_CONNECT_MESSAGE^> {
    /* The following code is for the use of the middleware infrastructure.
    * Applications are not expected to call it directly.
    */
    internal:
    BAC_SERVER_CONNECT_MESSAGEDataWriter(System::IntPtr impl);
};
// ---------------------------------------------------------------------------
// BAC_CLIENT_CONNECT_MESSAGETypeSupport
// ---------------------------------------------------------------------------

ref class BAC_CLIENT_CONNECT_MESSAGEPlugin;

/* A collection of useful methods for dealing with objects of type
* BAC_CLIENT_CONNECT_MESSAGE.
*/
public ref class BAC_CLIENT_CONNECT_MESSAGETypeSupport
: public DDS::TypedTypeSupport<BAC_CLIENT_CONNECT_MESSAGE^> {
    // --- Type name: --------------------------------------------------------
  public:
    static System::String^ TYPENAME = "BAC_CLIENT_CONNECT_MESSAGE";
  ...
  public:
    ...
    */
    ...
    /* Create an instance of the BAC_CLIENT_CONNECT_MESSAGE type.
    */
    static BAC_CLIENT_CONNECT_MESSAGE^ create_data();

    /* If instances of the BAC_CLIENT_CONNECT_MESSAGE type require any
    * explicit finalization, perform it now on the given sample.
    */
    static void delete_data(BAC_CLIENT_CONNECT_MESSAGE^ data);

    /* Write the contents of the data sample to standard out.
    */
    static void print_data(BAC_CLIENT_CONNECT_MESSAGE^ a_data);

    /* Perform a deep copy of the contents of one data sample over those of
    * another, overwriting it.
    */
    static void copy_data(
        BAC_CLIENT_CONNECT_MESSAGE^ dst_data,
        BAC_CLIENT_CONNECT_MESSAGE^ src_data);
  ...
  public:
    ...
    virtual BAC_CLIENT_CONNECT_MESSAGE^ create_data_untyped() override;

  public:
    static BAC_CLIENT_CONNECT_MESSAGETypeSupport^ get_instance();

    BAC_CLIENT_CONNECT_MESSAGETypeSupport();

  private:
    static BAC_CLIENT_CONNECT_MESSAGETypeSupport^ _singleton;
    BAC_CLIENT_CONNECT_MESSAGEPlugin^ _type_plugin;
};
...
/**
* A reader for the BAC_CLIENT_CONNECT_MESSAGE type.
*/
public ref class BAC_CLIENT_CONNECT_MESSAGEDataReader :
public DDS::TypedDataReader<BAC_CLIENT_CONNECT_MESSAGE^> {
    /* The following code is for the use of the middleware infrastructure.
    * Applications are not expected to call it directly.
    */
    internal:
    BAC_CLIENT_CONNECT_MESSAGEDataReader(System::IntPtr impl);
};
...
/**
* A writer for the BAC_CLIENT_CONNECT_MESSAGE user type.
*/
public ref class BAC_CLIENT_CONNECT_MESSAGEDataWriter :
public DDS::TypedDataWriter<BAC_CLIENT_CONNECT_MESSAGE^> {
    /* The following code is for the use of the middleware infrastructure.
    * Applications are not expected to call it directly.
    */
    internal:
    BAC_CLIENT_CONNECT_MESSAGEDataWriter(System::IntPtr impl);
};
// ---------------------------------------------------------------------------
