...
namespace enNet
{
    ...
    public static class PublisherExtensions
    {
        ...
        public static DDS.DataWriter CreateDataWriter(this DDS.Publisher publisher,
            DDS.Topic topic)
        {
            try
            {
        ...
        /// <returns>DataWriter</returns>
        public static DDS.DataWriter CreateDataWriterWithProfile(this DDS.Publisher publisher,
